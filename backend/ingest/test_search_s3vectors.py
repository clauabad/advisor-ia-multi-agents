...
SAGEMAKER_ENDPOINT = os.getenv('SAGEMAKER_ENDPOINT', 'advisor-embedding-endpoint')
...
def main():
    ...
    print("=" * 60)
    print("Advisor S3 Vectors Database Explorer")
    print("=" * 60)
    ...
    search_queries = [
        "tesla inc. (tsla) is an electric vehicle and clean energy company. It designs, manufactures, and sells electric vehicles, energy storage systems, and solar panels.",
        "amazon.com inc. (amzn) is a multinational technology company focusing on e-commerce, cloud computing (aws), digital streaming, and artificial intelligence.",
        "nvidia corporation (nvda) designs graphics processing units (gpus) for gaming and professional markets, as well as system on chip units for mobile computing and automotive.",
    ]
