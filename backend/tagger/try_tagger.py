...
class TaggerTest:
    ...
    def __init__(self):
        self.lambda_client = boto3.client('lambda', region_name='ca-central-1')
        self.db = Database()
    ...
    def deploy_tagger(self):
        ...
        try:
            ...
            bucket_name = f"advisor-lambda-packages-{boto3.client('sts').get_caller_identity()['Account']}"
            ...
            waiter.wait(FunctionName='advisor-tagger')
