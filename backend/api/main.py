"""
FastAPI backend for Advisor Financial Advisor
...
app = FastAPI(
    title="Advisor Financial Advisor API",
...
sqs_client = boto3.client('sqs', region_name=os.getenv('DEFAULT_AWS_REGION', 'ca-central-1'))
