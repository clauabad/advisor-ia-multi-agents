#!/usr/bin/env python3
"""
Deploy advisor researcher service to AWS App Runner
"""
...
def main():
    print("Advisor Researcher Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "advisor-researcher"
    ...
    password = run_command(
        ["aws", "ecr", "get-login-password", "--region", "us-east-1"], capture_output=True
    )
    ...
    try:
        services = run_command(
            [
                ...
                region,
                "--query",
                "ServiceSummaryList[?ServiceName=='advisor-researcher'].ServiceArn",
                "--output",
                "json",
            ],
            capture_output=True,
        ...
        if services:
            ...
            if service_arns:
                                    ...
                                    "ImageConfiguration": {
                                        ...
                                        "RuntimeEnvironmentVariables": {
                                            ...
                                            "ADVISOR_API_KEY": os.environ.get("ADVISOR_API_KEY", ""),
                                             "ADVISOR_API_ENDPOINT": os.environ.get(
                ...
                print("  2. Select 'advisor-researcher' service")
