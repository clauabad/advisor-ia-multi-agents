...
TAGGER_FUNCTION = os.getenv("TAGGER_FUNCTION", "advisor-tagger")
REPORTER_FUNCTION = os.getenv("REPORTER_FUNCTION", "advisor-reporter")
CHARTER_FUNCTION = os.getenv("CHARTER_FUNCTION", "advisor-charter")
RETIREMENT_FUNCTION = os.getenv("RETIREMENT_FUNCTION", "advisor-retirement")
