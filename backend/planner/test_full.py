#!/usr/bin/env python3
"""
Run a full end-to-end test of the Advisor agent orchestration.
...
# Get configuration
QUEUE_NAME = os.getenv('SQS_QUEUE_NAME', 'advisor-analysis-jobs')
...
def main():
    """Run the full test."""
    print("=" * 70)
    print("🎯 Advisor Agent Orchestration - Full Test")
    print("=" * 70)
